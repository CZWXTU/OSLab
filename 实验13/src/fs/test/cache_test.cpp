...
int main() {
    std::vector<Testcase> tests = {
        ...
        //{"single", [] { crash::test_parallel(100, 1, 5, 0); }},
        {"parallel_1", [] { crash::test_parallel(100, 2, 5, 0); }},
        {"parallel_2", [] { crash::test_parallel(100, 4, 5, 0); }},
        //{"parallel_3", [] { crash::test_parallel(50, 4, 10, 1); }},
        //{"parallel_4",
